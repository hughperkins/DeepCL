...
PropagateFc::PropagateFc( OpenCLHelper *cl, LayerDimensions dim, ActivationFunction const*fn ) :
    ...
    // [[[cog
    // import stringify
    // stringify.write_kernel2( "kernel", "cl/propagate_fc.cl", "propagate_filter_matches_inboard", 'options' )
    // ]]]
    // generated using cog:
    ...
    "\n" 
    "";
    kernel = cl->buildKernelFromString( kernelSource, "propagate_filter_matches_inboard", options, "cl/propagate_fc.cl" );
    // [[[end]]]
}
