...
//    string options = "-D OP2(val_one, val_two)=" + op->getDefine();

    // [[[cog
    // import stringify
    // stringify.write_kernel( "kernel", "cl/per_element_op.cl" )
    // ]]]
    // generated using cog, from cl/per_element_op.cl:
    ...
    kernel = cl->buildKernelFromString( renderedKernel, clKernelName, "", "cl/per_element_op.cl" );
