...
public:
    virtual ~NetAction2() {}
    virtual void run( Trainable *net, int epoch, InputData *inputData, OutputData *outputData ) = 0;
};
...
public:
    ...
    virtual void run( Trainable *net, int epoch, InputData *inputData, OutputData *outputData );
    float getEpochLoss() {
        return epochLoss;
    }
