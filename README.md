...
```
* For me, after 12 epochs, the test accuracy was 97.2% +/-0.1%, which seems somewhat plausible, compared to other implementations [MNIST database](http://yann.lecun.com/exdb/mnist/)
