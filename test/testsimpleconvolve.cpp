...
TEST( testsimpleconvolve, backprop_weights_2_upstreamboardsize2 ) {
    const int batchSize = 1;
...
TEST( testsimpleconvolve, backprop_weights_2_upstreamboardsize3_filtersize3 ) {
    const int batchSize = 1;
...
TEST( testsimpleconvolve, backprop_weights_2_upstreamboardsize4_filtersize3 ) {
    const int batchSize = 1;
...
TEST( testsimpleconvolve, backprop_weights_2_upstreamboardsize4_filtersize3_relu ) {
    const int batchSize = 1;
    const int upstreamBoardSize = 4;
    const int boardSize = 2;
    const int filterSize = 3;
...
TEST( testsimpleconvolve, backprop_weights_2_upstreamboardsize5_filtersize3 ) {
    const int batchSize = 1;
...
TEST( testsimpleconvolve, backprop_weights_2_upstreamboardsize3_filtersize1 ) {
    const int batchSize = 1;
    const int upstreamBoardSize = 3;
    const int boardSize = 3;
    const int filterSize = 1;
...
TEST( testsimpleconvolve, backprop_weights_2_upstreamboardsize16_filtersize1 ) {
    const int batchSize = 1;
...
TEST( testsimpleconvolve, backprop_weights_2_upstreamboardsize17_filtersize1 ) {
    const int batchSize = 1;
...
TEST( testsimpleconvolve, backprop_weights_2_upstreamboardsize17_filtersize1_moredata ) {
    const int batchSize = 1;
    const int upstreamBoardSize = 17;
    const int boardSize = 17;
    const int filterSize = 1;
