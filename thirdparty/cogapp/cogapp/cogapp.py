...
class CogOptions:
    ...
    def parseArgs(self, argv):
        ...
        try:
            opts, self.args = getopt.getopt(argv, 'cdD:eI:n:o:qrs:Uvw:xz',
                                            ['begin-spec=', 'end-spec=',
                                             'end-output='])
...
# 20150105: -q quiet option added by Hugh Perkins: only shows changed files
