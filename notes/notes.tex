...
\[ \partialderivative{E}{w_{ji}} = \partialderivative{E}{o_i} \partialderivative{o_i}{s_i} \partialderivative{s_i}{w_{ji}} \]
...
\[ \partialderivative{E}{s^l_i} = \partialderivative{E}{s^{l+1}_i} \partialderivative{s^{l+1}_i}{o^l_i} \partialderivative{o^l_i}{s^l_i}  \]
\[ \]
...
\[ o_i = \sigma(s_i) \] \[ \partialderivative{o_i}{s_i} = o_i(1-o_i) \]

\ult{tanh}

\[ o_i = \tanh(s_i) \] \[ \partialderivative{o_i}{s_i} = 1-(o_i)^2 \]
