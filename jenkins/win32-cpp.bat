...
echo set(JPEG_INCLUDE_DIR "%CD%\..\turbojpeg-win32" CACHE PATH "JPEG_INCLUDE_DIR")>>initcache.cmake
echo set(JPEG_LIBRARY "%CD%\..\turbojpeg-win32\turbojpeg-static.lib" CACHE PATH "JPEG_LIBRARY")>>initcache.cmake
