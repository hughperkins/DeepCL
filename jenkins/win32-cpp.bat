...
set(JPEG_INCLUDE_DIR "%CD%\..\turbojpeg-win32" CACHE PATH "JPEG_INCLUDE_DIR")>>initcache.cmake
set(JPEG_LIBRARY "%CD%\..\turbojpeg-win32\turbojpeg-static.lib" CACHE PATH "JPEG_LIBRARY")>>initcache.cmake
"c:\program files (x86)\cmake\bin\cmake" -G "Visual Studio 10 2010" -C initcache.cmake -D JPEG_LIBRARY=%CD%\..\turbojpeg-win32\turbojpeg-static.lib ..
