...
#define SWIGTYPE_p_Adadelta swig_types[1]
#define SWIGTYPE_p_Adagrad swig_types[2]
#define SWIGTYPE_p_Annealer swig_types[3]
#define SWIGTYPE_p_BatchResult swig_types[4]
#define SWIGTYPE_p_ConvolutionalMaker swig_types[5]
#define SWIGTYPE_p_CrossEntropyLossMaker swig_types[6]
#define SWIGTYPE_p_DropoutMaker swig_types[7]
#define SWIGTYPE_p_EasyCL swig_types[8]
#define SWIGTYPE_p_FullyConnectedMaker swig_types[9]
#define SWIGTYPE_p_GenericLoader swig_types[10]
#define SWIGTYPE_p_InputLayerMaker swig_types[11]
#define SWIGTYPE_p_LayerMaker2 swig_types[12]
#define SWIGTYPE_p_Nesterov swig_types[13]
#define SWIGTYPE_p_NetLearner swig_types[14]
#define SWIGTYPE_p_NetdefToNet swig_types[15]
#define SWIGTYPE_p_NeuralNet swig_types[16]
#define SWIGTYPE_p_NormalizationLayerMaker swig_types[17]
#define SWIGTYPE_p_PoolingMaker swig_types[18]
#define SWIGTYPE_p_QLearner2 swig_types[19]
#define SWIGTYPE_p_Rmsprop swig_types[20]
#define SWIGTYPE_p_SGD swig_types[21]
#define SWIGTYPE_p_SoftMaxMaker swig_types[22]
#define SWIGTYPE_p_SquareLossMaker swig_types[23]
#define SWIGTYPE_p_Trainer swig_types[24]
#define SWIGTYPE_p_TrainingContext swig_types[25]
#define SWIGTYPE_p_cl_device_id swig_types[26]
#define SWIGTYPE_p_cl_platform_id swig_types[27]
#define SWIGTYPE_p_float swig_types[28]
#define SWIGTYPE_p_floatArray swig_types[29]
#define SWIGTYPE_p_floatSlice swig_types[30]
#define SWIGTYPE_p_int swig_types[31]
#define SWIGTYPE_p_intArray swig_types[32]
#define SWIGTYPE_p_intSlice swig_types[33]
...
static int _wrap_Adadelta_instance(lua_State* L) {
  int SWIG_arg = 0;
  EasyCL *arg1 = (EasyCL *) 0 ;
  float arg2 ;
  Adadelta *result = 0 ;
  
  SWIG_check_num_args("Adadelta::instance",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Adadelta::instance",1,"EasyCL *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Adadelta::instance",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_EasyCL,0))){
    SWIG_fail_ptr("Adadelta_instance",1,SWIGTYPE_p_EasyCL);
  }
  
  arg2 = (float)lua_tonumber(L, 2);
  result = (Adadelta *)Adadelta::instance(arg1,arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Adadelta,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_Adadelta(lua_State* L) {
  int SWIG_arg = 0;
  EasyCL *arg1 = (EasyCL *) 0 ;
  float arg2 ;
  Adadelta *result = 0 ;
  
  SWIG_check_num_args("Adadelta::Adadelta",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Adadelta::Adadelta",1,"EasyCL *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Adadelta::Adadelta",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_EasyCL,0))){
    SWIG_fail_ptr("new_Adadelta",1,SWIGTYPE_p_EasyCL);
  }
  
  arg2 = (float)lua_tonumber(L, 2);
  result = (Adadelta *)new Adadelta(arg1,arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Adadelta,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Adadelta_asString(lua_State* L) {
  int SWIG_arg = 0;
  Adadelta *arg1 = (Adadelta *) 0 ;
  std::string result;
  
  SWIG_check_num_args("Adadelta::asString",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Adadelta::asString",1,"Adadelta *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Adadelta,0))){
    SWIG_fail_ptr("Adadelta_asString",1,SWIGTYPE_p_Adadelta);
  }
...
static int _wrap_Adadelta_train(lua_State* L) {
  int SWIG_arg = 0;
  Adadelta *arg1 = (Adadelta *) 0 ;
  NeuralNet *arg2 = (NeuralNet *) 0 ;
  TrainingContext *arg3 = (TrainingContext *) 0 ;
  ...
  SWIG_check_num_args("Adadelta::train",5,5)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Adadelta::train",1,"Adadelta *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Adadelta::train",2,"NeuralNet *");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Adadelta::train",3,"TrainingContext *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("Adadelta::train",4,"float const *");
  if(!SWIG_isptrtype(L,5)) SWIG_fail_arg("Adadelta::train",5,"float const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Adadelta,0))){
    SWIG_fail_ptr("Adadelta_train",1,SWIGTYPE_p_Adadelta);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_NeuralNet,0))){
    SWIG_fail_ptr("Adadelta_train",2,SWIGTYPE_p_NeuralNet);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_TrainingContext,0))){
    SWIG_fail_ptr("Adadelta_train",3,SWIGTYPE_p_TrainingContext);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Adadelta_train",4,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Adadelta_train",5,SWIGTYPE_p_float);
  }
...
static int _wrap_Adadelta_trainFromLabels(lua_State* L) {
  int SWIG_arg = 0;
  Adadelta *arg1 = (Adadelta *) 0 ;
  NeuralNet *arg2 = (NeuralNet *) 0 ;
  TrainingContext *arg3 = (TrainingContext *) 0 ;
  ...
  SWIG_check_num_args("Adadelta::trainFromLabels",5,5)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Adadelta::trainFromLabels",1,"Adadelta *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Adadelta::trainFromLabels",2,"NeuralNet *");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Adadelta::trainFromLabels",3,"TrainingContext *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("Adadelta::trainFromLabels",4,"float const *");
  if(!SWIG_isptrtype(L,5)) SWIG_fail_arg("Adadelta::trainFromLabels",5,"int const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Adadelta,0))){
    SWIG_fail_ptr("Adadelta_trainFromLabels",1,SWIGTYPE_p_Adadelta);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_NeuralNet,0))){
    SWIG_fail_ptr("Adadelta_trainFromLabels",2,SWIGTYPE_p_NeuralNet);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_TrainingContext,0))){
    SWIG_fail_ptr("Adadelta_trainFromLabels",3,SWIGTYPE_p_TrainingContext);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Adadelta_trainFromLabels",4,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_int,0))){
    SWIG_fail_ptr("Adadelta_trainFromLabels",5,SWIGTYPE_p_int);
  }
...
static void swig_delete_Adadelta(void *obj) {
Adadelta *arg1 = (Adadelta *) obj;
delete arg1;
}
static swig_lua_method swig_Adadelta_methods[] = {
    {"asString", _wrap_Adadelta_asString}, 
    {"train", _wrap_Adadelta_train}, 
    {"trainFromLabels", _wrap_Adadelta_trainFromLabels}, 
    {0,0}
};
static swig_lua_attribute swig_Adadelta_attributes[] = {
    {0,0,0}
};
static swig_lua_attribute swig_Adadelta_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Adadelta_cls_methods[] = {
    {"instance", _wrap_Adadelta_instance}, 
    {0,0}
};
static swig_lua_const_info swig_Adadelta_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_Adadelta_bases[] = {0,0};
static const char *swig_Adadelta_base_names[] = {"Trainer *",0};
static swig_lua_class _wrap_class_Adadelta = { "Adadelta", &SWIGTYPE_p_Adadelta,_wrap_new_Adadelta, swig_delete_Adadelta, swig_Adadelta_methods, swig_Adadelta_attributes, { "Adadelta", swig_Adadelta_cls_methods, swig_Adadelta_cls_attributes, swig_Adadelta_cls_constants }, swig_Adadelta_bases, swig_Adadelta_base_names };
...
static const struct luaL_Reg swig_commands[] = {
    ...
    { "Adadelta_instance", _wrap_Adadelta_instance},
...
static void *_p_AdadeltaTo_p_Trainer(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Trainer *)  ((Adadelta *) x));
}
...
static swig_type_info _swigt__p_Adadelta = {"_p_Adadelta", "Adadelta *", 0, 0, (void*)&_wrap_class_Adadelta, 0};
...
static swig_cast_info _swigc__p_Adadelta[] = {  {&_swigt__p_Adadelta, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Trainer[] = {  {&_swigt__p_Adadelta, _p_AdadeltaTo_p_Trainer, 0, 0},  {&_swigt__p_Nesterov, _p_NesterovTo_p_Trainer, 0, 0},  {&_swigt__p_Trainer, 0, 0, 0},  {&_swigt__p_SGD, _p_SGDTo_p_Trainer, 0, 0},  {&_swigt__p_Annealer, _p_AnnealerTo_p_Trainer, 0, 0},  {&_swigt__p_Adagrad, _p_AdagradTo_p_Trainer, 0, 0},  {&_swigt__p_Rmsprop, _p_RmspropTo_p_Trainer, 0, 0},{0, 0, 0, 0}};
