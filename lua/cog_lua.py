...
#
#
# doc is out of date, but this is intended to be lua version of the
...
def lua_write_overrideable_class( pxd_module, pxd_class, pyx_class, defs, skip_names ):
    """writes the lua class in the lua file that the .lua modules
