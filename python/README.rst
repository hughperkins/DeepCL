...
See
`test\_deepcl.py <https://github.com/hughperkins/DeepCL/blob/master/python/test_deepcl_numpy.py>`__
for an example of:
...
-  note that you need ``numpy`` installed to run these examples
